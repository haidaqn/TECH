...
export class BaseRepository<T extends Document> {
    ...
    async findByCondition(filter, field?: any | null, option?: any | null, populate?: any | null): Promise<any> {
    ...
    async updateOne(filter, update, option?: any | null) {
        return this.model.updateOne(filter as FilterQuery<T>, update, option);
    }
}
